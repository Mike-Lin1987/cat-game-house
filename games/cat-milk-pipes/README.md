...
一款完全離線的原創旋轉管線益智遊戲。玩家旋轉管線把鮮奶送到所有貓咪碗；每隻貓都喝到牛奶時就會通關。
...
- 玩家通關只要求全部貓咪碗都從鮮奶槽收到牛奶；其他未通奶管線、洩漏或迴圈不阻止完成。
- 固定關卡的正式答案仍採更嚴格的品質標準：全部有效格連通、零洩漏、無迴圈，且匹配邊數等於有效格數減一。
- 除鮮奶槽外，正式答案的所有葉節點都必須是貓咪碗。
